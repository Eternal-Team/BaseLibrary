...
namespace BaseLibrary.Utility
{
    public static partial class Utility
    {
        ...
        public static long CountCoins(this List<Item> inv, out bool overFlowing)
        {
	        long num = inv.Select(x =>
	        {
		        switch (x.type)
		        {
			        case 71:
			        ...
			        case 72:
				        return x.stack * 100;
			        case 73:
				        return x.stack * 10000;
			        case 74:
				        return x.stack * 1000000;
			        default:
				        return 0;
		        }
	        }).Sum();

	        if (num >= Utils.MaxCoins)
	        {
		        overFlowing = true;
		        return Utils.MaxCoins;
	        }
