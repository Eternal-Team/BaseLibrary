...
namespace BaseLibrary.UI.Elements
{
	public class UIContainerSlot : BaseElement
	{
		...
		/// </summary>
		//public event Func<(Item currentItem, Item mouseItem), bool> CanInteract;
		public event Action OnInteract;

		public Item Item
		{
			get { return Handler.GetStackInSlot(slot); }
			set { Handler.SetStackInSlot(slot, value); }
		}

		public UIContainerSlot(ItemStackHandler handler, int slot = 0)
		{
			Width = Height = (40, 0);
