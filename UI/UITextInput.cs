...
// 	{
// 		public static readonly UITextInputSettings Default = new UITextInputSettings
// 		{
...
// 			{
// 				if (ChatManager.GetStringSize(Font, Text.Substring(0, i), Vector2.One).X < clickedX) selectionStart = i;
// 			}
//
// 			selected = null;
//
