...
public class TestUI : ModSystem
{
	...
	{
		_baseElement = new BaseElement
		{
			test = true,
			Children =
			[
				new BaseElement { test = false }
			]
		};

		_uiLayer = new UILayer();
		_uiLayer.Add(_baseElement);
		Input.Input.LayerStack.PushLayer(_uiLayer);
	}

	public override void PostDrawInterface(SpriteBatch spriteBatch)
	{
		_uiLayer.OnDraw(spriteBatch, Main.gameTimeCache);
	}

	public override void UpdateUI(GameTime gameTime)
	{
		_uiLayer.OnUpdate(gameTime);
	}
}
...
public class UILayer : Layer
{
	...
	private List<BaseElement> Elements = new();
	...
	public void Add(BaseElement ui)
	{
		ui.Recalculate();
		Elements.Add(ui);
	}
	...
	{
		foreach (BaseElement element in Elements.Reverse<BaseElement>())
		{
