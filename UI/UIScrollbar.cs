...
public class UIScrollbar : BaseElement
{
	...
	public UIScrollbar()
	{
		if (texture == null) texture = ModContent.Request<Texture2D>("Terraria/Images/UI/Scrollbar").Value;
		if (barSliderTexture == null) barSliderTexture = ModContent.Request<Texture2D>(BaseLibrary.TexturePath + "UI/BarSlider").Value;
