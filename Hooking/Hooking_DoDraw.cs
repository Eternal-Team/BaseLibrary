...
//		public static MethodInfo miLookForColorTiles = typeof(Main).GetMethod("lookForColorTiles", defaultFlags);
//		public static Action<object> LookForColorTiles = obj => miLookForColorTiles.Invoke(obj, null);
//		public static MethodInfo miDrawToMap = typeof(Main).GetMethod("DrawToMap", defaultFlags);
...
//			Main.ForcedMinimumZoom = Max(1f, val, val2);
