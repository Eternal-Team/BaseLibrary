...
namespace BaseLibrary
{
	...
	public class MultiValueDictionary<TKey, TValue> : IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
	{
		...
		** Constructors
		...
		{
			//if (capacity < 0) throw new ArgumentOutOfRangeException(nameof(capacity), Strings.ArgumentOutOfRange_NeedNonNegNum);
		...
		** Concrete Methods
		...
		public void AddRange(TKey key, IEnumerable<TValue> values)
		{
			...
			foreach (TValue value in values) collection.AddValue(value);
